...
static ngx_command_t  ngx_http_core_commands[] = {
    ...
    { ngx_string("connection_pool_size"),
      ...
      NGX_HTTP_SRV_CONF_OFFSET,   /* 配置项在http配置中偏移  */
      offsetof(ngx_http_core_srv_conf_t, connection_pool_size),  /* connection_pool_size 在srv conf中偏移 */
      &ngx_http_core_pool_size_p }, /* 进行指令参数检查 */
